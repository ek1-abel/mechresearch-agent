"""State models used by the MechResearch deep research workflow."""
...
class TodoItem:
    ...
    kb_context: Optional[str] = field(default=None)
...
class EvaluationResult:
    ...
    has_tech_stack: bool = field(default=False)
    has_risks: bool = field(default=False)
    has_actionable_steps: bool = field(default=False)
